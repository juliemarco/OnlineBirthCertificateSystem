                            ...
                            <div class="sparkline13-list shadow-reset">
                                <div class="sparkline13-hd">
                                    <div class="main-sparkline13-hd">
                                        <h1> <?php echo "$uid"; ?>Certificate Lists</h1>
    ...
    <tr>
       ...
       <td><?php  echo htmlentities($row->MobileNumber);?></td>
        ...
        <?php } else { ?> <td><?php  echo htmlentities($row->Status);?>
                  ...
                  <?php } ?>
                                                    <td class="datatable-ct"><a href="certificates.php?viewid=<?php echo htmlentities ($row->ID);?>">
                                                    <button class="btn btn-white btn-action btn-xs"><i class="fa fa-folder"></i> View</button></a>
                                                    </td>
                                                </tr>
                                             <?php $cnt=$cnt+1;}} ?>  
