...
<body>
    ...
    <!-- ***** Hero Area Start ***** -->
    <div class="fancy-hero-area bg-img bg-overlay animated-img" style="background-image: url(img/bg-img/image.jpg);">
    </div>
    <!-- ***** Hero Area End ***** -->
                    ...
                    <div class="col-12 h-100">
                        <div class="copywrite-content h-100 d-flex align-items-center justify-content-between">
                            ...
                            <div class="copywrite-text">
                                ...
                                Copyright &copy;<script>document.write(new Date().getFullYear());</script> Online Birth Certificate System @@ 2022
